...
namespace OBeco {
    ...
    public partial class BibliotecaDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Matricula, string Telefone) {
...
namespace OBeco.BibliotecaDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuarios] WHERE (([ID_Usuarios] = @Original_ID_Usuarios) AND (" +
                "[Matricula] = @Original_Matricula) AND ([Telefone] = @Original_Telefone))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [Matricula] = @Matricula, [Telefone] = @Telefone WHERE (([ID_Usuarios] = @Original_ID_Usuarios) AND ([Matricula] = @Original_Matricula) AND ([Telefone] = @Original_Telefone));
SELECT ID_Usuarios, Matricula, Telefone FROM Usuarios WHERE (ID_Usuarios = @ID_Usuarios)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_Usuarios, Matricula, Telefone FROM dbo.Usuarios";
        ...
        public virtual int Delete(int Original_ID_Usuarios, string Original_Matricula, string Original_Telefone) {
        ...
        public virtual int Update(string Matricula, string Telefone, int Original_ID_Usuarios, string Original_Matricula, string Original_Telefone, int ID_Usuarios) {
            if ((Matricula == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Matricula, string Telefone, int Original_ID_Usuarios, string Original_Matricula, string Original_Telefone) {
            return this.Update(Matricula, Telefone, Original_ID_Usuarios, Original_Matricula, Original_Telefone, Original_ID_Usuarios);
        }
    }
